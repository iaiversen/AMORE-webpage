...
**Note:** If your search strings contain special characters (quotes, parentheses, ®, etc.), wrap them in backticks like this: `'search string'` to ensure proper formatting.Example:
