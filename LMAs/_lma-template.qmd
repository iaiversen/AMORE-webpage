...
oxytocin:
  ...
  assessment_method: # Choose one or more:
    - "Behavioral assessment"
    - "Physiological response"
    - "Biological sample collection"
    - "Genetic studies"
    - "Neural/imaging measurement"
  route: # Options: Central, Peripheral, Various administration routes, 
  dosage: # Options: 8 IU, 16 IU, 24 IU, 32 IU, 40 IU, Variable dosage
population:
  status: # Options: Healthy, Clinical, Mixed
  age_group: # Options: Children, Adolescents, Adults, Older Adults, Mixed Age Groups
  clinical_type: 
outcomes:
  biological:
  ...
  clinical:
    - # Neurodevelopmental, Mood Disorders, Psychotic Disorders, Addiction and Substance Use, Eating Disorders"Autism" 
update-frequency: 
dois:
  preregistration: "10.XXXX/template-prereg"
  preprint: "10.XXXX/template-preprint"
  publication: "10.XXXX/template-publication"
format: ### NB!  This is important to not touch but include ## 
  html: ### NB!  This is important to not touch but include ##
    page-layout: full ### NB!  This is important to not touch but include ##
    toc: true ### NB!  This is important to not touch but include ##
    toc-title: "On this page" ### NB!  This is important to not touch but include ##
    toc-location: right ### NB!  This is important to not touch but include ##
    toc-depth: 3 ### NB!  This is important to not touch but include ##
---
