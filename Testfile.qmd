...
/* Default body background - gradient for all pages */
body {
  background: linear-gradient(-45deg, 
    #0A2A5E, #1E50A0, #3c6997ff, #0A2A5E
  ) !important;
...
/* White background override for project pages ONLY */
...
/* Force contact page to always have gradient background */
...
/* Project page h2 styling - no border */
...
/* Project pages get solid white navbar */
...
=            Table of Contents              =
=                                           =
= Enhanced TOC navigation with spacing      =
===============================================*/
...
=            About Page                     =
=                                           =
= Hero section and tabbed interface         =
===============================================*/
...
.contact-container {
  ...
  /* Force the contact page logo to always appear */
  &::before {
    content: '' !important;
