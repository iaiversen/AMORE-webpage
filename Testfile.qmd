...
.title,
h1 {
  font-size: 2.5rem; /* Increased from 2.2rem for better visibility on laptop */
  color: #0A2A5E;
  margin-top: 1.8rem;
  margin-bottom: 2rem;
  font-weight: 700;
...
@media (max-width: 480px) {
  ...
  /* Proper proportional scaling: 2.5rem * 0.5 = 1.25rem */
  .title:not(.subtitle-text),
  h1:not(.hero-content h1):not(.project-hero-content h1) {
    font-size: 1.25rem;
  }
  
  /* Proper proportional scaling: 1.8rem * 0.5 = 0.9rem */
  h2:not(.contact-section h2) {
    font-size: 0.9rem;
  }
  
  /* h3 scales proportionally too */
  h3:not(.feature-box h3) {
    font-size: 0.65rem; /* 1.3rem * 0.5 */
  }
  
  /* Scale hero tagline proportionally - 1.4rem * 0.5 = 0.7rem */
  ...
  /* Scale hero title proportionally - 2.2rem * 0.5 = 1.1rem */
  .hero-content h1,
...
.hero-content h1 {
  font-size: 2.2rem; /* Back to reasonable size, but larger than tagline */
  margin-bottom: 1.5rem;
  font-weight: 700;
  color: white;
  margin-top: 0;
...
.hero-content .hero-tagline {
  font-size: 1.4rem; /* Smaller than main title */
  margin-bottom: 2rem;
  opacity: 0.9;
  line-height: 1.6;
  color: white;
...
/* Target the Quarto div-based hero tagline specifically */
.hero-section .hero-content .hero-tagline,
.hero-section .hero-tagline {
...
/* Make sure the main hero title is properly sized */
.hero-section .hero-content h1,
.hero-section h1 {
...
/* Target the paragraph that contains the main hero title */
.hero-section .hero-content p {
  font-size: 2.2rem !important;
  font-weight: 700 !important;
  color: white !important;
...
/* Additional responsive adjustments for project pages */
@media (min-width: 481px) and (max-width: 767px) {
  .project-hero-section {
    min-height: 28vh;
...
/* Project page content sections get white background */
...
/* Modern card styling for project sections */
.search-string-box,
.resources-panel {
  background: white;
  border-radius: 12px;
