...
1.  Important information.
    ...
    1.  the different languages
        ...
        1.  Quarto is multilingual, the AMORE website uses different languages \*Javascript, html, R, Quarto Markdown, Shell, and SCSS . The Github page informs all languages used under the About section to the AMORE/website github page.
