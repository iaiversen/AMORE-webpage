...
Domain management: Netlify deployment and domain name (Must be paid for)

R/Rstudio management: maintenance script

Shinyapp.io

Github - transfer Github repository to Dan, make sure all paths are correct if needed.

Nettskjema - the forms are only active for so long, this must be expanded or new identical forms must be made. The forms today are functioning until 2028 (Check precise date)
...
-   How to handle feedback from forms
