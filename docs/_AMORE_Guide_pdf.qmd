...
### Save and Push Your Project to GitHub

After creating your project page, you must push it to the GitHub repository so it appears on the live website.
...
1. Create a \`.Renviron\` file in the \`shiny-meta/\` directory:
\`\`\`bash
\# .Renviron file structure
SHINYAPPS_ACCOUNT=your-account-name
SHINYAPPS_TOKEN=your-token-here
SHINYAPPS_SECRET=your-secret-here
\`\`\`

2. Get your credentials from shinyapps.io:
\* Log in to https://www.shinyapps.io/
\* Navigate to Account meta-oxytocin → Tokens
\* Show/Generate token
\* Copy the account name, token, and secret
...
1.  The template contains sections that are either required or optional for new project pages:
...
3.  Everything under #\| echo: true in the {r} code chunks should be included. If you are uncertain use the \_lma-template.qmd to visualise what the script should look like.

4.  When the script is created, **Render** to preview

![render button](images/render%20button.png){width="357"}

![the correct render preview settings](images/setting%20render.png){width="338"}

### Push Your Project to GitHub

After creating and testing your project page, you need to push it to GitHub so it appears on the live website.
...
# 2. Add your new project file
git add LMAs/yourname_topic.qmd

# 3. Commit with a descriptive message
git commit -m "Add [YourName] [Topic] living meta-analysis"

# 4. Push to GitHub
git push origin main

# Verify your push by visting the browser repository to see the new project file in the LMAs folder. 
```
...
**Screenshots from the template**: The neon green text is where you need to customize the content.

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/first-01.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/second.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/third.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/third.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/fourth.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/fourth.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/fifth.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/sixth.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/seventh.png)

![screenshot of resources section. Neongreeen font is where you need to customize the code.](images/seventh.png)

![Visual of resources section](images/resources%20image.png){width="459"}
