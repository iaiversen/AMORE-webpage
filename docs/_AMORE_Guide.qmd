...
### 5.1 Using template to fill in project information section for section
...
```{r}
#| label: YAML section for projects options 
#| eval: false 
#| echo: true 
...
### Add html with different containers that the new users can "shop", just copy paste to projects they make. 
