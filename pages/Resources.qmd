...
[Access the textbook](https://onlinelibrary.wiley.com/doi/book/10.1002/9780470743386){.resource-link target="_blank"}
:::

::: {.resource-item}
### Doing Meta-Analysis with R: A Hands-On Guide {#doing-meta-analysis-r}
...
[Access the textbook](https://bookdown.org/MathiasHarrer/Doing_Meta_Analysis_in_R/#cite-the-packages){.resource-link target="_blank"}
:::
